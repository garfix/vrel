...
class TestComposer(unittest.TestCase):
    ...
    def test_variable_unification(self):
        ...
        simple_grammar = [
            {"syn": "s(E1) -> np(E2) verb(E2, E3) np(E3)", "sem": lambda np1, verb, np2: Atom(DUMMY, verb, np1, np2)},
        ...
        self.assertEqual(repr(semantics), "($6, flows, ($4, river, quantifier='the'), ($5, sea, quantifier='the'))")

from vrel.core.constants import E1, E2, E3, E4, E5, e1, e2, e3, Body, Range
...
def get_read_grammar1():
    return [
        ...
        # X is a Y
        {
            ...
            "sem": lambda noun, is1, a, np: [("let", T1, "true")]
            + noun
            + [("intent_tell", np)],
        },
        ...
        # dark-gray things are not white
        {
            ...
            "sem": lambda np, are, adj2: [
                ("let", T1, "true"),
                ("let", T2, "false"),
                ("intent_learn", adj2[0], np),
            ],
        },
        ...
        # any thing that burns rapidly burns
        {
            ...
            "sem": lambda verb1, verb2: [
                ("let", T1, "true"),
                ("let", T2, "true"),
                ("intent_learn", verb2[0], verb1),
            ],
        },
        # np
        ...
        {
            "syn": "np(E1, T1) -> np(E1, T1) 'that' 'is' np(E1, T1)",
            "sem": lambda np1, np2: np1 + np2,
        },
        # verb
        ...
        {
            "syn": "adj(E1, T1) -> 'combustable'",
            "sem": lambda: [("combustable", E1, T1)],
        },
        # noun
        {
        ...
        {"syn": "common_noun(E1, T1) -> 'oxide'", "sem": lambda: [("oxide", E1, T1)]},
        {
            ...
            "sem": lambda: [("sulfide", E1, T1)],
        },
        {
            "syn": "common_noun(E1, T1) -> 'chloride'",
            "sem": lambda: [("chloride", E1, T1)],
        },
        {
            "syn": "common_noun(E1, T1) -> 'brittle'",
            "sem": lambda: [("brittle", E1, T1)],
        },
        {
            "syn": "common_noun(E1, T1) -> 'element'",
            "sem": lambda: [("element", E1, T1)],
        },
        {
            "syn": "common_noun(E1, T1) -> 'elements'",
            "sem": lambda: [("element", E1, T1)],
        },
        {
            "syn": "common_noun(E1, T1) -> 'compound'",
            "sem": lambda: [("compound", E1, T1)],
        },
        {
            "syn": "common_noun(E1, T1) -> 'compounds'",
            "sem": lambda: [("compound", E1, T1)],
        },
        ...
        {
            "syn": "proper_noun(E1) -> /\w+/ main_noun(E1)",
            "sem": lambda token, main_noun: [
                ("resolve_name", token + " " + main_noun, E1)
            ],
        },
        # the major part a compound noun
        {
            "syn": "main_noun(E1) -> 'oxide'",
            "sem": lambda: "oxide",
            "dialog": [("oxide", e1, "true")],
        },
        {
            "syn": "main_noun(E1) -> 'chloride'",
            "sem": lambda: "chloride",
            "dialog": [("chloride", e1, "true")],
        },
        {
            "syn": "main_noun(E1) -> 'sulfide'",
            "sem": lambda: "sulfide",
            "dialog": [("sulfide", e1, "true")],
        },
    ]

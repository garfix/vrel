...
class TestPAM(unittest.TestCase):
    ...
    def test_pam(self):
        ...
        tests = [
            ...
            # ],
            # [
            #     # Inference (2.2 Sample story)
            #     ["John wanted Bill's bicycle. He walked over to Bill and asked him if he would give it to him. Bill refused. Bill he would give him five dollars for it, but Bill would not agree. John told Bill he would break his arm if he didn't let him have it. Bill let John have the bicycle.", "OK"],
            #     ["Why did John walk over to Bill?", "Because he wanted to get his bicycle."],
            ...
            # ],
            # [
            #     # Goal subsumption (5.2 Goal subsumption state establishment)
            ...
            # ],
            # [
            #     # Goal subsumption (1.2 PAM (3); 5.3 Goal subsumption state replacement)
            ...
            # ],
            # [
            #     # Goal conflict resolution (7.3.1.1 Factors involved in time-based goal conflicts)
            ...
            # ],
            # [
            #     # Goal conflict resolution (1.2 PAM (4); 1.6 What this thesis is about; 7.3.1.2 Computer example)
            ...
            # ],
            # [
            #     # Goal competition (8.1.1 Goal competition)
            ...
            # ],
            # [
            #     # Anti-planning  9.3.2.1 A computer example
            ...
            # ],
            # [
            #     # Anti-planning  9.3.3.2.1 A Computer example
            ...
            # ],
            # [
            #     # Objects (1.2 PAM (2) and 11.2.2 Computer example)

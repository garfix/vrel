from vrel.core.constants import Range, Body, E1, E2
...
def get_read_grammar():
    return [
        ...
        {"syn": "adjective_clause(E1) -> vp(C1, E1)", "sem": lambda vp: vp},
        ...
        {"syn": "vp(C1, E1) -> verb(C1, E1)", "sem": lambda verb: verb},
        {"syn": "vp(C1, E1) -> verb(C1, E1) pp(C1)", "sem": lambda verb, pp: verb + pp},
        {"syn": "vp(C1, E1, E2) -> verb(C1, E1, E2)", "sem": lambda verb: verb},
        {
            "syn": "vp(C1, E1, E2) -> verb(C1, E1, E2) np(E2)",
            "sem": lambda verb, np: apply(np, verb),
        },
        {"syn": "vp(C1, E1, E2, E3) -> verb(C1, E1, E2, E3)", "sem": lambda verb: verb},
        {
        ...
        },
        {
            ...
            "sem": lambda np, noun: SemanticFunction(
                [Body], apply(np, noun + [("poss", E2, E1)] + Body)
            ),
        },
        {
        ...
        # nbar
        {"syn": "nbar(E1) -> adjp(E1) nbar(E1)", "sem": lambda adjp, nbar: adjp + nbar},
        ...
        },
        {
            ...
            "sem": lambda number: SemanticFunction(
                [Range, Body], Body + Range + [("number_of", E1, number)]
            ),
        },
        # verb
        {
        ...
        {"syn": "go() -> 'went'", "sem": lambda: []},
        {"syn": "copula() -> 'is'", "sem": lambda: []},
        {"syn": "copula() -> 'was'", "sem": lambda: []},
        # adverb
        {"syn": "adverb(E1) -> 'then'", "sem": lambda: []},
        {"syn": "adverb(E1) -> 'just'", "sem": lambda: []},
        {"syn": "adverb(E1) -> 'one day'", "sem": lambda: []},
        {
        ...
        # preposition
        {"syn": "prep(E1, E2) -> 'for'", "sem": lambda: [("for", E1, E2)]},
        {"syn": "prep(E1, E2) -> 'to'", "sem": lambda: [("to", E1, E2)]},
        {"syn": "prep(E1, E2) -> 'by'", "sem": lambda: [("by", E1, E2)]},
        {"syn": "prep(E1, E2) -> 'of'", "sem": lambda: [("of", E1, E2)]},
        # number

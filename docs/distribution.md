...
test on testpypi (change the version number)
    ...
    twine upload --repository-url https://test.pypi.org/legacy/ dist/vrel-0.1.0.tar.gz
    pip install -i https://test.pypi.org/simple/ vrel==0.1.0

upload to pypi

    twine upload dist/vrel-0.1.0.tar.gz
